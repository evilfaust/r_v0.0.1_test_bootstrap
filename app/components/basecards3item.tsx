...
const BaseCards3item = ({title, title1, title2, title3, discription1, discription2, discription3, imgurl}: { title: string;  imgurl: string; title1: string; discription1: string; title2: string; discription2: string; title3: string; discription3: string; } ) => {
