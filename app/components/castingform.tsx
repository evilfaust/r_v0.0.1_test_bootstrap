    ...
    try {
      ...
      const response = await axios.post(`https://api.telegram.org/bot${token}/sendMessage`, {
        ...
        text: `
          ...
          Раздел: Контактные данные интервьюера
  ...
  return (
      <>
          <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="p-2 rounded-3 text-light mb-3"
              style={{
                        border: "1px solid #FFC803",
                        backgroundColor: '#444863',
              }}
              >
                  <h5 className="pb-2" style={{color: '#FFC803'}}>Общая информация</h5>
                  ...
                  <Form.Group controlId="formConfidentialVacancy">
                      <Row className="mb-3">
                          ...
                          <Col lg={8}>
                              <div>
                                  <Form.Check inline label="Да" {...register('confidentialVacancy', {required: true})}
                                              type="radio" value="Да"/>
                                  <Form.Check inline label="Нет" {...register('confidentialVacancy', {required: true})}
                                              type="radio" value="Нет"/>
                              </div>
              ...
              >
                  <h5 style={{color: '#FFC803'}}>Контактные данные интервьюера</h5>
              ...
              >
                  <h5 style={{color: '#FFC803'}}>Общая информация о должности</h5>
                  ...
                  <Form.Group controlId="formAdministrativeSubordination">
                      <Row className="py-2">
                          ...
                          <Col lg={9}>
                              <Form.Control
                                  type="text" {...register('administrativeSubordination', {required: true})} />
                              {errors.administrativeSubordination &&
                                  <span className="text-danger">Это поле обязательно</span>}
                          </Col>
                      </Row>
                  </Form.Group>
                  ...
                  <Form.Group controlId="formSubordinates">
                      <Row className="py-2">
                          ...
                          <Col className="col-auto">
                              <div>
                                  <Form.Check inline label="Да" {...register('subordinates', {required: true})}
                                              type="radio" value="Да"/>
                                  <Form.Check inline label="Нет" {...register('subordinates', {required: true})}
                                              type="radio" value="Нет"/>
                              </div>
              ...
              >
                  <h5 style={{color: '#FFC803'}}>Требования к кандидату</h5>
                  ...
                  <Form.Group controlId="formCandidateGender">
                      <Row className="py-2">
                          ...
                          <Col className="col-auto">
                              <div>
                                  <Form.Check inline label="Муж." {...register('candidateGender', {required: true})}
                                              type="radio" value="Муж."/>
                                  <Form.Check inline label="Жен." {...register('candidateGender', {required: true})}
                                              type="radio" value="Жен."/>
                              </div>
                  ...
                  <Form.Group controlId="formEducation">
                      <Row className="py-2">
                          ...
                          <Col lg={9}>
                              <div>
                                  <Form.Check inline label="ВУЗ" {...register('educationLevel', {required: true})}
                                              type="radio"
                                              value="ВУЗ"/>
                                  <Form.Check inline label="Колледж" {...register('educationLevel', {required: true})}
                                              type="radio"
                                              value="Колледж"/>
                                  <Form.Check inline label="специальность" {...register('educationLevel', {required: true})}
                                              type="radio"
                                              value="специальность"/>
                                  <Form.Check inline label="специализация" {...register('educationLevel', {required: true})}
                                              type="radio"
                                              value="специализация"/>
                              </div>
                          </Col>
                      </Row>
                      <Form.Control type="text" placeholder="Предпочтительные учебные заведения" {...register('educationDetails', {required: true})} />
                  ...
                  <Form.Group controlId="formExperience">
                      <Row className="py-2">
                          <Col lg={4}>
                              <Form.Label>Опыт и стаж работы в какой отрасли/секторе предпочтителен (от
                                  лет)</Form.Label>
                          </Col>
                          <Col lg={8}>
                              <Form.Control  as="textarea" type="text" {...register('experience', {required: true})} />
                      ...
                      <Row className="py-2">
                          ...
                          <Col lg={8}>
                              <Form.Control as="textarea"
                                            rows={3} {...register('additionalRequirements', {required: true})} />
                  ...
                  <Form.Group controlId="formResponsibilities">
                      <Row className="py-2">
                          ...
                          <Col lg={8}>
                              <Form.Control as="textarea"
                                            rows={3} {...register('responsibilities', {required: true})} />
              ...
              >
                  <h5 style={{color: '#FFC803'}}>Условия найма специалиста</h5>
                  ...
                  <Form.Group controlId="formProbationPeriod">
                      <Row className="py-2">
                          ...
                          <Col lg={9}>
                              <div>
                                  <Form.Check inline label="3 месяца" {...register('probationPeriod', {required: true})}
                                              type="radio" value="3 месяца"/>
                                  <Form.Check inline
                                              label="6 месяцев" {...register('probationPeriod', {required: true})}
                                              type="radio" value="6 месяцев"/>
                                  <Form.Check inline
                                              label="9 месяцев" {...register('probationPeriod', {required: true})}
                                              type="radio" value="9 месяцев"/>
                                  <Form.Check inline
                                              label="12 месяцев" {...register('probationPeriod', {required: true})}
                                              type="radio" value="12 месяцев"/>
                              </div>
                  ...
                  <Form.Group controlId="formBusinessTrips">
                      <Row className="py-2">
                          ...
                          <Col lg={9}>
                              <div>
                                  <Form.Check inline label="Да" {...register('businessTrips', {required: true})}
                                              type="radio" value="Да"/>
                                  <Form.Check inline label="Нет" {...register('businessTrips', {required: true})}
                                              type="radio" value="Нет"/>
                              </div>
                  ...
                  <Form.Group controlId="formExistenceInStaffList">
                      <Row className="py-2">
                          <Col lg={5}>
                              <Form.Label>Существует ли данная должность в штатном расписании или это новая
                                  должность</Form.Label>
                          </Col>
                          <Col lg={7}>
                              <Form.Control as="textarea"
                                            rows={3} {...register('existenceInStaffList', {required: true})} />
                  ...
                  <Form.Group controlId="formReasonForVacancy">
                      <Row className="py-2">
                          ...
                          <Col lg={7}>
                              <Form.Control as="textarea"
                                            rows={3} {...register('reasonForVacancy', {required: true})} />
                  ...
                  {success &&
                      <Alert bgColor={'success'} icon={'✅ '} status="Отправлено!" message="Ваше сообщение отправлено 😊"
                             onClick={removeAlert}/>}
                  {error && <Alert bgColor={'danger'} icon={'❌ '} status="Ошибка!"
                                   message="Что-то пошло не так. Пожалуйста попробуйте позже 😢" onClick={removeAlert}/>}
          </Form>
      </>
);
};
